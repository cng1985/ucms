...
public class StockDayAction {
	...
	public String list(Pageable pageable, HttpServletRequest request, ModelMap model) {
		...
		Page<StockDay> pagination = manager.findPage(pageable);
	...
	public String save(StockDay bean, HttpServletRequest request, ModelMap model) {
	...
	public String update(Pageable pageable, StockDay bean,HttpServletRequest request, ModelMap model) {
