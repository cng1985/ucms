...
-- 导出 ucms 的数据库结构
DROP DATABASE IF EXISTS `ucms`;
CREATE DATABASE IF NOT EXISTS `ucms` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ucms`;

-- 导出  表 ucms.activity 结构
...
CREATE TABLE IF NOT EXISTS `activity` (
  ...
  CONSTRAINT `FK24r943kdkhofv6euw05a66v83` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FKj0xhtuxsig80ijl8y2m9qlm8x` FOREIGN KEY (`catalog_id`) REFERENCES `activity_catalog` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.activity 的数据：~0 rows (大约)
DELETE FROM `activity`;
/*!40000 ALTER TABLE `activity` DISABLE KEYS */;
/*!40000 ALTER TABLE `activity` ENABLE KEYS */;

-- 导出  表 ucms.activity_catalog 结构
...
CREATE TABLE IF NOT EXISTS `activity_catalog` (
  ...
  CONSTRAINT `FKi9yn9gnn9djfomgppfos0sogc` FOREIGN KEY (`pid`) REFERENCES `activity_catalog` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.activity_catalog 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `album_album` (
  ...
  CONSTRAINT `FKb28j7s432btfaynlc2ft12o0o` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.album_album 的数据：~0 rows (大约)
DELETE FROM `album_album`;
/*!40000 ALTER TABLE `album_album` DISABLE KEYS */;
/*!40000 ALTER TABLE `album_album` ENABLE KEYS */;

-- 导出  表 ucms.album_category 结构
...
CREATE TABLE IF NOT EXISTS `album_feed` (
  ...
  CONSTRAINT `FK867e395vayv607srm5dijy9jo` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.album_feed 的数据：~0 rows (大约)
DELETE FROM `album_feed`;
/*!40000 ALTER TABLE `album_feed` DISABLE KEYS */;
/*!40000 ALTER TABLE `album_feed` ENABLE KEYS */;

-- 导出  表 ucms.album_photo 结构
...
CREATE TABLE IF NOT EXISTS `album_photo` (
  ...
  CONSTRAINT `FK716u4nm9v4ib2c154jxwl6ov` FOREIGN KEY (`album_id`) REFERENCES `album_album` (`id`),
  CONSTRAINT `FKci8lm9bfx09ohlyn94inyid14` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FKeyyfgnxyndk5e3iaebdqegn4f` FOREIGN KEY (`category_id`) REFERENCES `album_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.album_photo 的数据：~0 rows (大约)
DELETE FROM `album_photo`;
/*!40000 ALTER TABLE `album_photo` DISABLE KEYS */;
/*!40000 ALTER TABLE `album_photo` ENABLE KEYS */;

-- 导出  表 ucms.album_photo_feeds 结构
...
CREATE TABLE IF NOT EXISTS `album_photo_feeds` (
  ...
  CONSTRAINT `FKa1xuj0vapw409bsb7t5dt9bjd` FOREIGN KEY (`PhotoFeed_id`) REFERENCES `album_feed` (`id`),
  CONSTRAINT `FKk0vl5583gj2ij15crk6wqvk59` FOREIGN KEY (`photos_id`) REFERENCES `album_photo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.album_photo_feeds 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `album_photo_tags` (
  ...
  CONSTRAINT `FK8bjxnv5i8setjy93980v6msw8` FOREIGN KEY (`tags_name`) REFERENCES `album_tag` (`name`),
  CONSTRAINT `FKj0h4wvaqnuix18mbprm73aj13` FOREIGN KEY (`Photo_id`) REFERENCES `album_photo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.album_photo_tags 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.article 的数据：~1 rows (大约)
DELETE FROM `article`;
/*!40000 ALTER TABLE `article` DISABLE KEYS */;
INSERT INTO `article` (`id`, `addDate`, `lastDate`, `comments`, `contents`, `exts`, `images`, `img`, `introduction`, `title`, `ups`, `views`, `catalog_id`, `user_id`) VALUES
	(1, '2017-10-25 16:08:36', '2017-10-25 16:08:36', NULL, '<p>学习中北文化学习中北文化</p>', NULL, NULL, '', '学习中北文化学习中北文化学习中北文化', '学习中北文化', NULL, NULL, 2, NULL);
/*!40000 ALTER TABLE `article` ENABLE KEYS */;

-- 导出  表 ucms.article_catalog 结构
...
-- 正在导出表  ucms.article_catalog 的数据：~4 rows (大约)
...
INSERT INTO `article_catalog` (`id`, `addDate`, `code`, `ids`, `lastDate`, `levelInfo`, `lft`, `name`, `rgt`, `sortNum`, `nums`, `pid`) VALUES
	(1, '2017-10-25 16:07:50', '', '1', '2017-10-25 16:07:50', 1, 1, '根节点', 8, 0, NULL, NULL),
	(2, '2017-10-25 16:07:59', '001', '1,2', '2017-10-25 16:07:59', 2, 2, 'java技术', 3, NULL, NULL, 1),
	(3, '2017-10-25 16:08:10', '002', '1,3', '2017-10-25 16:08:10', 2, 4, '软件新闻', 5, NULL, NULL, 1),
	(4, '2017-10-25 16:08:18', '003', '1,4', '2017-10-25 16:08:18', 2, 6, 'it资讯', 7, NULL, NULL, 1);
/*!40000 ALTER TABLE `article_catalog` ENABLE KEYS */;

-- 导出  表 ucms.article_comment 结构
...
-- 正在导出表  ucms.article_comment 的数据：~0 rows (大约)
DELETE FROM `article_comment`;
/*!40000 ALTER TABLE `article_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `article_comment` ENABLE KEYS */;

-- 导出  表 ucms.article_link_tag 结构
...
-- 正在导出表  ucms.article_link_tag 的数据：~0 rows (大约)
...
-- 导出  表 ucms.article_sensitive_category 结构
...
-- 正在导出表  ucms.article_sensitive_category 的数据：~0 rows (大约)
...
-- 导出  表 ucms.article_sensitive_word 结构
...
-- 正在导出表  ucms.article_sensitive_word 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.article_tag 的数据：~0 rows (大约)
DELETE FROM `article_tag`;
/*!40000 ALTER TABLE `article_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `article_tag` ENABLE KEYS */;

-- 导出  表 ucms.bbs_froum 结构
DROP TABLE IF EXISTS `bbs_froum`;
CREATE TABLE IF NOT EXISTS `bbs_froum` (
  ...
  CONSTRAINT `FK99cbquciodl5d60fv27360ey0` FOREIGN KEY (`pid`) REFERENCES `bbs_froum` (`id`),
  CONSTRAINT `FKcpeqv28x1i4pp9fraf175v9bf` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.bbs_froum 的数据：~8 rows (大约)
DELETE FROM `bbs_froum`;
/*!40000 ALTER TABLE `bbs_froum` DISABLE KEYS */;
INSERT INTO `bbs_froum` (`id`, `addDate`, `code`, `ids`, `lastDate`, `levelInfo`, `lft`, `name`, `rgt`, `sortNum`, `pid`, `user_id`) VALUES
	(1, '2017-11-27 09:50:53', '', '1', '2017-11-27 09:50:53', 1, 1, '根节点', 16, 0, NULL, NULL),
	(2, '2017-11-27 09:51:09', '001', '1,2', '2017-11-27 09:51:09', 2, 2, '前端技术', 11, NULL, 1, NULL),
	(3, '2017-11-27 09:51:20', '002', '1,3', '2017-11-27 09:51:20', 2, 12, '后端技术', 13, NULL, 1, NULL),
	(4, '2017-11-27 09:51:31', '003', '1,4', '2017-11-27 09:51:31', 2, 14, '网站站务', 15, NULL, 1, NULL),
	(5, '2017-11-27 09:52:03', '011', '1,2,5', '2017-11-27 09:52:03', 3, 3, 'jQuery', 4, NULL, 2, NULL),
	(6, '2017-11-27 09:52:50', '012', '1,2,6', '2017-11-27 09:52:50', 3, 5, 'javascript', 6, NULL, 2, NULL),
	(7, '2017-11-27 09:52:56', '01', '1,2,7', '2017-11-27 09:52:56', 3, 7, 'css', 8, NULL, 2, NULL),
	(8, '2017-11-27 09:53:13', '002', '1,2,8', '2017-11-27 09:53:13', 3, 9, 'html', 10, NULL, 2, NULL);
/*!40000 ALTER TABLE `bbs_froum` ENABLE KEYS */;

-- 导出  表 ucms.bbs_froum_like 结构
DROP TABLE IF EXISTS `bbs_froum_like`;
CREATE TABLE IF NOT EXISTS `bbs_froum_like` (
  ...
  CONSTRAINT `FKjcpxxoemhrqpoiqgpcylflqqc` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FKq69g1l1r0cvjlktxqcxx7xbh2` FOREIGN KEY (`forum_id`) REFERENCES `bbs_froum` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.bbs_froum_like 的数据：~0 rows (大约)
DELETE FROM `bbs_froum_like`;
/*!40000 ALTER TABLE `bbs_froum_like` DISABLE KEYS */;
/*!40000 ALTER TABLE `bbs_froum_like` ENABLE KEYS */;

-- 导出  表 ucms.bbs_froum_post 结构
DROP TABLE IF EXISTS `bbs_froum_post`;
CREATE TABLE IF NOT EXISTS `bbs_froum_post` (
  ...
  CONSTRAINT `FKgj7qy7909dd2ol6jyqsng4vma` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FKibbpsgu59dqb2pn93frws97ue` FOREIGN KEY (`forum_id`) REFERENCES `bbs_froum` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.bbs_froum_post 的数据：~2 rows (大约)
DELETE FROM `bbs_froum_post`;
/*!40000 ALTER TABLE `bbs_froum_post` DISABLE KEYS */;
INSERT INTO `bbs_froum_post` (`id`, `addDate`, `lastDate`, `name`, `forum_id`, `user_id`) VALUES
	(1, '2017-11-27 09:52:15', '2017-11-27 09:52:15', 'ttttttttttttt', 5, 1),
	(2, '2017-11-27 09:52:20', '2017-11-27 09:52:20', 'ttttt', 5, 1);
/*!40000 ALTER TABLE `bbs_froum_post` ENABLE KEYS */;

-- 导出  表 ucms.bbs_froum_post_comment 结构
DROP TABLE IF EXISTS `bbs_froum_post_comment`;
CREATE TABLE IF NOT EXISTS `bbs_froum_post_comment` (
  ...
  CONSTRAINT `FK7c99tgmo41xp25p806yb3td7f` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FKl3609kpq1ndm8sj537g0n4h52` FOREIGN KEY (`post_id`) REFERENCES `bbs_froum_post` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.bbs_froum_post_comment 的数据：~0 rows (大约)
DELETE FROM `bbs_froum_post_comment`;
/*!40000 ALTER TABLE `bbs_froum_post_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `bbs_froum_post_comment` ENABLE KEYS */;

-- 导出  表 ucms.bbs_froum_post_like 结构
DROP TABLE IF EXISTS `bbs_froum_post_like`;
CREATE TABLE IF NOT EXISTS `bbs_froum_post_like` (
  ...
  CONSTRAINT `FK54q1j1txofkjnp86488hg4bmt` FOREIGN KEY (`post_id`) REFERENCES `bbs_froum_post` (`id`),
  CONSTRAINT `FKpjxwd5j68bgpp0ca3t47pdr9u` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.bbs_froum_post_like 的数据：~0 rows (大约)
DELETE FROM `bbs_froum_post_like`;
/*!40000 ALTER TABLE `bbs_froum_post_like` DISABLE KEYS */;
/*!40000 ALTER TABLE `bbs_froum_post_like` ENABLE KEYS */;

-- 导出  表 ucms.bbs_froum_post_text 结构
DROP TABLE IF EXISTS `bbs_froum_post_text`;
CREATE TABLE IF NOT EXISTS `bbs_froum_post_text` (
  ...
  CONSTRAINT `FKwm5wd5qoe1gldvyqrnsnncg6` FOREIGN KEY (`post_id`) REFERENCES `bbs_froum_post` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.bbs_froum_post_text 的数据：~2 rows (大约)
DELETE FROM `bbs_froum_post_text`;
/*!40000 ALTER TABLE `bbs_froum_post_text` DISABLE KEYS */;
INSERT INTO `bbs_froum_post_text` (`id`, `note`, `post_id`) VALUES
	(1, 'tttttt', 1),
	(2, 'ttttttt', 2);
/*!40000 ALTER TABLE `bbs_froum_post_text` ENABLE KEYS */;

-- 导出  表 ucms.config_data_version 结构
...
-- 正在导出表  ucms.config_data_version 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.friendlink 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.menu 的数据：~17 rows (大约)
DELETE FROM `menu`;
...
INSERT INTO `menu` (`id`, `addDate`, `code`, `ids`, `lastDate`, `levelInfo`, `lft`, `name`, `rgt`, `sortNum`, `catalog`, `icon`, `nums`, `path`, `permission`, `pid`) VALUES
	(1, '2017-09-25 14:25:39', '', '1', '2017-09-25 14:25:39', 1, 1, '根节点', 34, 0, NULL, NULL, NULL, NULL, NULL, NULL),
	(2, '2017-09-25 14:34:01', NULL, '1,2', '2017-09-25 14:34:01', 2, 2, '系统设置', 21, 0, 0, 'fa  fa-gear', 0, '', '2', 1),
	...
	(12, '2017-10-25 16:01:34', NULL, '1,12', '2017-10-25 16:01:34', 2, 22, '文章管理', 27, NULL, 0, 'fa fa-circle-o', NULL, '', '', 1),
	...
	(15, '2017-11-27 09:31:01', NULL, '1,15', '2017-11-27 09:31:01', 2, 28, '论坛管理', 33, NULL, 0, 'fa fa-circle-o', NULL, '', '', 1),
...
CREATE TABLE IF NOT EXISTS `note` (
  ...
  CONSTRAINT `FKfy0n186b8arfdbdkkwp2h5cc5` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.note 的数据：~0 rows (大约)
DELETE FROM `note`;
/*!40000 ALTER TABLE `note` DISABLE KEYS */;
/*!40000 ALTER TABLE `note` ENABLE KEYS */;

-- 导出  表 ucms.plugin_config 结构
...
-- 正在导出表  ucms.plugin_config_attribute 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  CONSTRAINT `FK1qppmll4xo1lc5mo29t1btl4p` FOREIGN KEY (`catalog_id`) REFERENCES `question_catalog` (`id`),
  CONSTRAINT `FKtish917q79dtiyfly6coc9080` FOREIGN KEY (`userid`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.question 的数据：~0 rows (大约)
DELETE FROM `question`;
/*!40000 ALTER TABLE `question` DISABLE KEYS */;
/*!40000 ALTER TABLE `question` ENABLE KEYS */;

-- 导出  表 ucms.question_answer 结构
...
CREATE TABLE IF NOT EXISTS `question_answer` (
  ...
  CONSTRAINT `FKqywdip0nvnrxt1ticvl3kydnw` FOREIGN KEY (`userid`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.question_answer 的数据：~0 rows (大约)
DELETE FROM `question_answer`;
/*!40000 ALTER TABLE `question_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `question_answer` ENABLE KEYS */;

-- 导出  表 ucms.question_answer_vote 结构
...
CREATE TABLE IF NOT EXISTS `question_answer_vote` (
  ...
  CONSTRAINT `FKl4eaxmxp38b602u7slx5wpvqy` FOREIGN KEY (`userid`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FKm1h5ifaa0uijbicdhjgspbcxh` FOREIGN KEY (`answer_id`) REFERENCES `question_answer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.question_answer_vote 的数据：~0 rows (大约)
DELETE FROM `question_answer_vote`;
/*!40000 ALTER TABLE `question_answer_vote` DISABLE KEYS */;
/*!40000 ALTER TABLE `question_answer_vote` ENABLE KEYS */;

-- 导出  表 ucms.question_catalog 结构
...
CREATE TABLE IF NOT EXISTS `question_catalog` (
  ...
  CONSTRAINT `FKcsqfog6i2c9dluroqo1e5dwdd` FOREIGN KEY (`pid`) REFERENCES `question_catalog` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.question_catalog 的数据：~0 rows (大约)
...
-- 导出  表 ucms.question_favorite 结构
...
CREATE TABLE IF NOT EXISTS `question_favorite` (
  ...
  CONSTRAINT `FKclt463wvm2gf9s4rl8ldjq8w1` FOREIGN KEY (`userid`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FKhsljtebjn3ao1k2dihn89flu5` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.question_favorite 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `question_points` (
  ...
  CONSTRAINT `FKcp6ky2ygv6jcaokw12xxeg2gi` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.question_points 的数据：~0 rows (大约)
DELETE FROM `question_points`;
/*!40000 ALTER TABLE `question_points` DISABLE KEYS */;
/*!40000 ALTER TABLE `question_points` ENABLE KEYS */;

-- 导出  表 ucms.question_tag 结构
...
CREATE TABLE IF NOT EXISTS `question_vote` (
  ...
  CONSTRAINT `FKmepf1jggv0klnbk6ctaprihdh` FOREIGN KEY (`userid`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.question_vote 的数据：~0 rows (大约)
DELETE FROM `question_vote`;
/*!40000 ALTER TABLE `question_vote` DISABLE KEYS */;
/*!40000 ALTER TABLE `question_vote` ENABLE KEYS */;

-- 导出  表 ucms.question_word 结构
...
-- 正在导出表  ucms.site_app_version 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.site_config 的数据：~1 rows (大约)
...
INSERT INTO `site_config` (`id`, `addDate`, `lastDate`, `description`, `domainName`, `favicon`, `icp`, `keywords`, `logo`, `pageSize`, `shortName`, `theme`, `title`) VALUES
	(1, '2017-10-25 14:46:35', '2017-10-25 14:46:35', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'adminlte', NULL);
/*!40000 ALTER TABLE `site_config` ENABLE KEYS */;

-- 导出  表 ucms.site_link 结构
...
-- 正在导出表  ucms.site_link 的数据：~1 rows (大约)
...
INSERT INTO `site_link` (`id`, `addDate`, `lastDate`, `icon`, `name`, `sortNum`, `target`, `url`, `linkType_id`) VALUES
	(1, '2017-10-20 10:19:55', '2017-10-20 10:19:55', NULL, '海底捞', 1, '_blank', 'http://www.yichisancun.com/', 2);
/*!40000 ALTER TABLE `site_link` ENABLE KEYS */;

-- 导出  表 ucms.site_link_type 结构
...
-- 正在导出表  ucms.site_link_type 的数据：~2 rows (大约)
...
INSERT INTO `site_link_type` (`id`, `addDate`, `code`, `ids`, `lastDate`, `levelInfo`, `lft`, `name`, `rgt`, `sortNum`, `pid`) VALUES
	(1, '2017-10-20 10:12:15', '', '1', '2017-10-20 10:12:15', 1, 1, '根节点', 4, 0, NULL),
	(2, '2017-10-20 10:14:35', '001', '1,2', '2017-10-20 10:14:35', 2, 2, '合作伙伴', 3, NULL, 1);
/*!40000 ALTER TABLE `site_link_type` ENABLE KEYS */;

-- 导出  表 ucms.site_template_web 结构
...
-- 正在导出表  ucms.site_template_web 的数据：~0 rows (大约)
...
-- 导出  表 ucms.site_theme_config 结构
...
-- 正在导出表  ucms.site_theme_config 的数据：~2 rows (大约)
...
CREATE TABLE IF NOT EXISTS `stock` (
  ...
  CONSTRAINT `FKrg26e7f0ce0ha3393rmsypakq` FOREIGN KEY (`catalog_id`) REFERENCES `stock_catalog` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2782 DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.stock 的数据：~2,864 rows (大约)
DELETE FROM `stock`;
...
CREATE TABLE IF NOT EXISTS `stock_catalog` (
  ...
  CONSTRAINT `FK1xbak41g3p45h9007alv7qd5u` FOREIGN KEY (`pid`) REFERENCES `stock_catalog` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.stock_catalog 的数据：~0 rows (大约)
DELETE FROM `stock_catalog`;
/*!40000 ALTER TABLE `stock_catalog` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_catalog` ENABLE KEYS */;

-- 导出  表 ucms.stock_day 结构
...
CREATE TABLE IF NOT EXISTS `stock_day` (
  ...
  CONSTRAINT `FK81rtcqs6iavvbxgw5cyxdb2pm` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.stock_day 的数据：~0 rows (大约)
DELETE FROM `stock_day`;
/*!40000 ALTER TABLE `stock_day` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_day` ENABLE KEYS */;

-- 导出  表 ucms.stock_detail 结构
...
CREATE TABLE IF NOT EXISTS `stock_detail` (
  ...
  CONSTRAINT `FK5hpba5xjvduisruknvsvmvlum` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.stock_detail 的数据：~0 rows (大约)
DELETE FROM `stock_detail`;
/*!40000 ALTER TABLE `stock_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_detail` ENABLE KEYS */;

-- 导出  表 ucms.stock_like 结构
...
CREATE TABLE IF NOT EXISTS `stock_like` (
  ...
  CONSTRAINT `FK5bp6iyjnol1xg9rhc76su3byk` FOREIGN KEY (`uid`) REFERENCES `user_info` (`id`),
  CONSTRAINT `FK5ghcyfr8kmang43p1twveytkm` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.stock_like 的数据：~0 rows (大约)
DELETE FROM `stock_like`;
/*!40000 ALTER TABLE `stock_like` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_like` ENABLE KEYS */;

-- 导出  表 ucms.stock_note 结构
...
CREATE TABLE IF NOT EXISTS `stock_note` (
  ...
  CONSTRAINT `FKee461td1sbgr6lr5il0yiop66` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`id`),
  CONSTRAINT `FKih8mh2mms7elcb7fsuc7rqtce` FOREIGN KEY (`uid`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.stock_note 的数据：~0 rows (大约)
DELETE FROM `stock_note`;
/*!40000 ALTER TABLE `stock_note` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_note` ENABLE KEYS */;

-- 导出  表 ucms.stock_record 结构
...
CREATE TABLE IF NOT EXISTS `stock_record` (
  ...
  CONSTRAINT `FKbc0h7youp6l1ifnchkwajsx8` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  ucms.stock_record 的数据：~0 rows (大约)
DELETE FROM `stock_record`;
/*!40000 ALTER TABLE `stock_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_record` ENABLE KEYS */;

-- 导出  表 ucms.user_account 结构
...
-- 正在导出表  ucms.user_account 的数据：~1 rows (大约)
DELETE FROM `user_account`;
/*!40000 ALTER TABLE `user_account` DISABLE KEYS */;
INSERT INTO `user_account` (`id`, `addDate`, `lastDate`, `accountType`, `loginSize`, `password`, `salt`, `username`, `user_id`) VALUES
	(1, '2017-09-25 14:14:56', '2017-11-27 09:52:56', 2, 51, '9bf876c77352cf2f852892f4da1e041622bd5f1e', 'df02ab36fed44aa5', 'admin', 1);
/*!40000 ALTER TABLE `user_account` ENABLE KEYS */;

-- 导出  表 ucms.user_feedback 结构
...
-- 正在导出表  ucms.user_feedback 的数据：~0 rows (大约)
DELETE FROM `user_feedback`;
/*!40000 ALTER TABLE `user_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_feedback` ENABLE KEYS */;

-- 导出  表 ucms.user_info 结构
...
-- 正在导出表  ucms.user_info 的数据：~1 rows (大约)
DELETE FROM `user_info`;
/*!40000 ALTER TABLE `user_info` DISABLE KEYS */;
INSERT INTO `user_info` (`id`, `addDate`, `lastDate`, `avatar`, `email`, `name`, `note`, `qq`, `sex`, `catalog`, `loginSize`, `password`, `phone`, `registerType`, `salt`, `state`, `username`) VALUES
	(1, '2017-10-25 16:13:15', '2017-11-27 09:52:56', '', '735529126@qq.com', 'ada.young', '代码', '735529126', '男', NULL, 85, NULL, NULL, '账号', NULL, NULL, NULL);
/*!40000 ALTER TABLE `user_info` ENABLE KEYS */;

-- 导出  表 ucms.user_info_attribute 结构
...
-- 正在导出表  ucms.user_info_attribute 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.user_oauth_config 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.user_oauth_token 的数据：~0 rows (大约)
...
-- 正在导出表  ucms.user_role 的数据：~1 rows (大约)
DELETE FROM `user_role`;
/*!40000 ALTER TABLE `user_role` DISABLE KEYS */;
INSERT INTO `user_role` (`id`, `addDate`, `lastDate`, `alias`, `description`, `name`, `roleType`, `catalog_id`) VALUES
	(1, '2017-11-27 09:35:05', '2017-11-27 09:35:05', 'admin', 'admin', 'admin', 0, 2);
/*!40000 ALTER TABLE `user_role` ENABLE KEYS */;

-- 导出  表 ucms.user_role_authority 结构
...
-- 正在导出表  ucms.user_role_authority 的数据：~15 rows (大约)
...
-- 导出  表 ucms.user_role_catalog 结构
...
-- 正在导出表  ucms.user_role_catalog 的数据：~2 rows (大约)
...
-- 正在导出表  ucms.user_role_links 的数据：~1 rows (大约)
...
-- 导出  表 ucms.user_verification 结构
...
-- 正在导出表  ucms.user_verification 的数据：~0 rows (大约)
